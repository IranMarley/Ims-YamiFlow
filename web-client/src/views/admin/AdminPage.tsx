...
import { useAdminStats, useAdminUsers, useToggleUserStatus, useUpdateUser } from '../../hooks/useAdmin'
import {
  useRoles,
  useCreateRole,
  useDeleteRole,
...
type Tab = 'overview' | 'roles' | 'permissions'
                    ...
                    <td className="px-5 py-3 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          variant="secondary"
                          onClick={() => {
                            setEditingRole({ id: role.id, name: role.name, originalName: role.name, description: role.description ?? '' })
                          }}
                        >
                          Edit
                        </Button>
