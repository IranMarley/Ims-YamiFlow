...
public record UpdateRoleCommand(string RoleId, string Description) : IRequest<Result>;
...
public class UpdateRoleHandler(IIamService iamService) : IRequestHandler<UpdateRoleCommand, Result>
{
